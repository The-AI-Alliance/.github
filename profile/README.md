    ...
    <tbody>
      ...
      <tr>
        <td>
          <ul>
            <li>
              <a href="https://github.com/The-AI-Alliance/open-trusted-model-initiative">repo</a>
            </li>
            <li>
              <a href="https://github.com/The-AI-Alliance/open-trusted-model-initiative/issues">issues</a>
            </li>
            <li>
              <a href="https://github.com/The-AI-Alliance/open-trusted-model-initiative/discussions">discussions</a>
            </li>
          </ul>
        </td>
        <td>
